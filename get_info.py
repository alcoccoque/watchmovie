...
def get_cast_info(c: object) -> tuple:
    ...
    try:
        ...
        raise ValueError("Cast info isn't full")
...
def get_movie_info(r: object) -> tuple:
    ...
    try:
        ...
        raise ValueError("Movie info ins't full")
...
def get_reviews_info(r: object) -> tuple:
    ...
    try:
        ...
        raise ValueError("Reviews info isn't full")
def get_recommends_info(r: object) -> tuple:
    ...
    """
    try:
        rec_films = movie.recommendations(r.id)[:15]
        ...
        raise ValueError("Recommendations isn't full")
...
def get_movie_object(id: int) -> object:
    ...
    try:
        ...
        raise ValueError("This movie is not in our database")
...
def get_random() -> tuple:
    ...
    :return: movie object, cast list
    """
    movies = pd.read_csv("datasets/movies.csv", delimiter=',', usecols=['title'])
    try:
...
def get_info(r: object, c: list) -> tuple:
    ...
    try:
        ...
        raise ValueError("Info about movie isn't full")


print(get_recommends_info(movie.details(13564)).__next__())